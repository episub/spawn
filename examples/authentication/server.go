...
import (
	...
	em "github.com/episub/spawn/middleware"
	api "github.com/example/todo/graph"
	"github.com/example/todo/loader"
	"github.com/example/todo/resolvers"
...
type config struct {
	...
	DBUser       string `env:"DB_USER" envDefault:"spawn"`
	DBPass       string `env:"DB_PASS" envDefault:"spawn"`
